    ...
    <div class="top-header">
        ...
        <div class="container">
            ...
            <div class="col-md-6 ow-right-padding col-sm-8">
                ...
                <ul class="top-menu">
                <li><a title="Login" href="{{route('dangnhap')}}">Đăng nhập</a></li>
                    <li><a title="Register" href="{{route('taotaikhoan')}}">Đăng kí</a></li>
                </ul>
            </div>
        </div><!-- container /- -->
    </div><!-- top-header /- -->
                ...
                <div class="col-md-4 col-sm-12 col-xs-12 cart-link ow-right-padding">
                    ...
                    <div class="cart-dropdown" >
                        <table>
                            ...
                            @if(Session::get('cart'))
                                ...
                                @foreach($product_cart as $product)
                                    ...
                                    <tr>
                                        <td class="product-thumb"><a href="#"><img width="80px" height="80px" src="{{$product['item']['product_image']}}" alt="cart-hover" /></a></td>
                        ...
                        <div class="sub-total">
                            ...
                            {{-- @dd(Session::has('cart')); --}}
                            <p><span>Số lượng</span>@if(Session::has('cart')){{number_format(Session('cart')->totalQty)}}@endif sản phẩm</p>
                            <p><span>Tổng</span>@if(Session::has('cart')){{number_format(Session('cart')->totalPrice)}}@endif VND</p>
                        </div>
            ...
            <nav class="navbar navbar-default navbar-static-top">
                ...
                <div class="navbar-collapse collapse" id="navbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            <a title="Shop" href="#" class="dropdown-toggle" data-toggle="dropdown">Danh mục</a>
