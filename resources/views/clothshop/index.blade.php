<x-master>
		...
		<div class="container">
			...
			<div class=" product-box-main">
				...
				<div class="col-md-3 col-sm-6 col-xs-6 main-product">
					...
					<a href="chi-tiet-sanpham/{{ $products->id }}" class="product-title">{{$products->product_name }}</a>
					<ul class="star">
						<li>
	...
	{{-- <li><a title="product" href="{{route('productCategories',$categories->id)}}">{{$categories->category_name}}</a></li> --}}
			...
			<div class="col-md-6 col-sm-4 blog-content">
				<article>
					<div class="col-md-4 col-sm-4 col-xs-4 ow-left-padding">
						<a class="post-thumbnail"><img src="images/blog/post-thumbnail-1.jpg" alt="post-thumbnail"/></a>
					</div>
					<div class="col-md-8 col-sm-8 col-xs-8">
						<header class="entry-header">
							<h2 class="entry-title"><a href="#">Tên sản phẩm 1</a></h2>
						</header>
						<footer class="entry-footer">
							<span class="posted-on">
								<span class="sr-only">Ngày đăng </span>
								<a rel="bookmark" href="#">
							...
							<span class="byline">
								<span class="author vcard">
									<span class="sr-only">Tên tài khoản </span>
									<a href="#" class="url fn n">Tên tài khoản
				...
				<article>
					<div class="col-md-4 col-sm-4 col-xs-4 ow-left-padding">
						<a class="post-thumbnail"><img src="images/blog/post-thumbnail-2.jpg" alt="post-thumbnail"/></a>
					</div>
					<div class="col-md-8 col-sm-8 col-xs-8">
						<header class="entry-header">
							<h2 class="entry-title"><a href="#">Tên sản phẩm 2</a></h2>
						</header>
						<footer class="entry-footer">
							<span class="posted-on">
								<span class="sr-only">Ngày đăng </span>
							...
							<span class="byline">
								<span class="author vcard">
									<span class="sr-only">Tên tài khoản </span>
									<a title="" href="#" class="url fn n">Tên tài khoản
										<svg viewBox="0 0 43.028 43.028">
											<path d="M39.561,33.971l-0.145,0.174c-4.774,5.728-11.133,8.884-17.902,8.884c-6.77,0-13.128-3.155-17.903-8.884l-0.144-0.174   l0.034-0.223c0.922-6.014,4.064-10.845,8.847-13.606l0.34-0.196l0.271,0.284c2.259,2.37,5.297,3.674,8.554,3.674   s6.295-1.305,8.554-3.674l0.271-0.284l0.34,0.196c4.783,2.761,7.925,7.592,8.848,13.606L39.561,33.971z M21.514,21.489   c5.924,0,10.744-4.82,10.744-10.744C32.258,4.821,27.438,0,21.514,0S10.77,4.821,10.77,10.744S15.59,21.489,21.514,21.489z"/>
										</svg>
									</a>
